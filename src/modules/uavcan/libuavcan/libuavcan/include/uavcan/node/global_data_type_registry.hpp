...
struct UAVCAN_EXPORT DefaultDataTypeRegistrator
{
	DefaultDataTypeRegistrator()
	{
		...
		const GlobalDataTypeRegistry::RegistrationResult res = GlobalDataTypeRegistry::instance().registerDataType<Type>(Type::DefaultDataTypeID);
...
GlobalDataTypeRegistry::RegistrationResult GlobalDataTypeRegistry::registerDataType(DataTypeID id)
{
	...
	entry.descriptor = DataTypeDescriptor(DataTypeKind(Type::DataTypeKind), id, Type::getDataTypeSignature(), Type::getDataTypeFullName());
