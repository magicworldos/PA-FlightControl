 ...
 * Parameter types
 */
template<typename U> struct ParameterType
{
	typedef const U& Type;
};
template<typename U> struct ParameterType<U&>
{
	typedef U& Type;
};
#if UAVCAN_CPP_VERSION > UAVCAN_CPP03
...
public:
	enum
	{
		Result = sizeof(True_) == sizeof(IsImplicitlyConvertibleFromTo<T1, T2>::test(returner<T1>()))
	};
};
...
{
	return CoerceOrFallbackImpl<From, To>::impl(from, default_, BooleanType<IsImplicitlyConvertibleFromTo<From, To>::Result>());
}
...
{
	return CoerceOrFallbackImpl<From, To>::impl(from, To(), BooleanType<IsImplicitlyConvertibleFromTo<From, To>::Result>());
}
/**
 * @}
 */
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<1>
{
	enum
	{
		Result = 1
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<4>
{
	enum
	{
		Result = 2
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<9>
{
	enum
	{
		Result = 3
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<16>
{
	enum
	{
		Result = 4
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<25>
{
	enum
	{
		Result = 5
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<36>
{
	enum
	{
		Result = 6
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<49>
{
	enum
	{
		Result = 7
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<64>
{
	enum
	{
		Result = 8
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<81>
{
	enum
	{
		Result = 9
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<100>
{
	enum
	{
		Result = 10
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<121>
{
	enum
	{
		Result = 11
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<144>
{
	enum
	{
		Result = 12
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<169>
{
	enum
	{
		Result = 13
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<196>
{
	enum
	{
		Result = 14
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<225>
{
	enum
	{
		Result = 15
...
template<> struct UAVCAN_EXPORT CompileTimeIntSqrt<256>
{
	enum
	{
		Result = 16
...
struct UAVCAN_EXPORT NumericTraits<double>
{
	...
	{
		return static_cast<double>(INFINITY) * static_cast<double>(INFINITY);
	}
...
struct UAVCAN_EXPORT NumericTraits<long double>
{
	...
	{
		return static_cast<long double>(INFINITY) * static_cast<long double>(INFINITY);
	}
