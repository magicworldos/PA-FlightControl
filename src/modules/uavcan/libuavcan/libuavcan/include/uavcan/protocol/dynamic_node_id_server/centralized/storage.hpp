...
class Storage
{
	...
	typedef Array<IntegerSpec<8, SignednessUnsigned, CastModeSaturate>, ArrayModeStatic, BitLenToByteLen<NodeID::Max + 1>::Result> OccupationMaskArray;
...
public:
	...
	{
		return occupation_mask_[node_id.get()];
	}
	
	uint8_t getSize() const
	{
		return static_cast<uint8_t>(occupation_mask_.count());
	}
};
