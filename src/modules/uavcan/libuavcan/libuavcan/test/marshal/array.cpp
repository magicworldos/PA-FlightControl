...
struct CustomType
{
	...
	enum
	{
		MinBitLen = A::MinBitLen + B::MinBitLen + C::MinBitLen
	};
	enum
	{
		MaxBitLen = A::MaxBitLen + B::MaxBitLen + C::MaxBitLen
	};
	...
	{
		return a == rhs.a && uavcan::areFloatsExactlyEqual(b, rhs.b) && c == rhs.c;
	}
...
struct CustomType2
{
	...
	enum
	{
		MinBitLen = A::MinBitLen + B::MinBitLen
	};
	enum
	{
		MaxBitLen = A::MaxBitLen + B::MaxBitLen
	};
	...
	{
		return uavcan::areFloatsExactlyEqual(a, rhs.a) && b == rhs.b;
	}
