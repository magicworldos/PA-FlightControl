...
{	
	...
	{	
		const uint8_t data[] =
		{	0xad, 0xbe, 0xfc};  // 10101101 10111110 11111100
		uavcan::StaticTransferBuffer<8> buf;
		uavcan::BitStream bs(buf);
...
{	
	...
	{   // Write
		...
		{	0xfc};                    // 11111100
		const uint8_t data3[] =
		{	0xde, 0xad, 0xbe, 0xef};  // 11011110 10101101 10111110 11101111
		const uint8_t data4[] =
