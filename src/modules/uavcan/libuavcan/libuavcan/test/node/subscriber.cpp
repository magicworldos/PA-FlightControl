...
struct SubscriptionListener
{
	...
	{
		return ExtendedBinder(this, &SelfType::receiveExtended);
	}
	SimpleBinder bindSimple()
	{
		return SimpleBinder(this, &SelfType::receiveSimple);
	}
};
...
{	
	...
	const uint8_t transfer_payload[] =
	{	0x42, 0x72, 0x08, 0xa5, 'M', 's', 'g'};
