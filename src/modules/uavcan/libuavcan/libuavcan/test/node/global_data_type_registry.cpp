...
struct DataTypeAMessage
{
	...
	enum
	{
		DataTypeKind = uavcan::DataTypeKindMessage
	};
	static uavcan::DataTypeSignature getDataTypeSignature()
	{
		return uavcan::DataTypeSignature(123);
	}
	static const char* getDataTypeFullName()
	{
		return "my_namespace.DataTypeA";
	}
};
...
struct DataTypeAService
{
	...
	enum
	{
		DataTypeKind = uavcan::DataTypeKindService
	};
	static uavcan::DataTypeSignature getDataTypeSignature()
	{
		return uavcan::DataTypeSignature(789);
	}
	static const char* getDataTypeFullName()
	{
		return "my_namespace.DataTypeA";
...
struct DataTypeB
{
	...
	static uavcan::DataTypeSignature getDataTypeSignature()
	{
		return uavcan::DataTypeSignature(456);
	}
	static const char* getDataTypeFullName()
	{
		return "my_namespace.DataTypeB";
	}
};
...
struct DataTypeC
{
	...
	static uavcan::DataTypeSignature getDataTypeSignature()
	{
		return uavcan::DataTypeSignature(654);
	}
	static const char* getDataTypeFullName()
	{
		return "foo.DataTypeC";
	}
};
...
struct DataTypeD
{
	...
	static uavcan::DataTypeSignature getDataTypeSignature()
	{
		return uavcan::DataTypeSignature(987);
	}
	static const char* getDataTypeFullName()
	{
		return "foo.DataTypeD";
	}
};
...
{
	return uavcan::DataTypeDescriptor(uavcan::DataTypeKind(Type::DataTypeKind), dtid, Type::getDataTypeSignature(), Type::getDataTypeFullName());
}
