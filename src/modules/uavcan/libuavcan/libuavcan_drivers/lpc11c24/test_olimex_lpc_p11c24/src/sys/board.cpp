...
constexpr PinMuxGroup pinmux[] = { { IOCON_PIO1_10, IOCON_FUNC0 | IOCON_MODE_INACT },                                          // Error LED
...
void initClock()
{
	...
	while (SystemCoreClock != TargetSystemCoreClock)
	{
	}  // Loop forever if the clock failed to initialize properly
}
