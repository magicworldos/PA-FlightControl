...
// Include library
    ...
    && defined(MICROCDR_VERSION_MAJOR) \
    && defined(MICROCDR_VERSION_MINOR)
#pragma comment(lib, EPROSIMA_LIB_PREFIX EPROSIMA_STRINGIZE(EPROSIMA_LIB_NAME) EPROSIMA_LIB_DEBUG_TAG "-" EPROSIMA_STRINGIZE(MICROCDR_VERSION_MAJOR) "." EPROSIMA_STRINGIZE(MICROCDR_VERSION_MINOR) ".lib")
#else
