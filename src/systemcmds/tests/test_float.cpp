...
bool FloatTest::singlePrecisionTests()
{
	...
	ut_assert("atan2f(1.0f, 1.0f) == 0.78539f", fabsf(atan2f_ones - 0.785398163397448278999490867136f) < 2.0f * FLT_EPSILON);
...
bool FloatTest::doublePrecisionTests()
{
	...
	ut_assert("testing pow() with magic value", (44330.0 * (1.0 - pow((96286LL / 101325.0), 0.190295))) - 428.2293 < DBL_EPSILON);
