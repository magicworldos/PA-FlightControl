...
bool MatrixTest::matrixAssignmentTests()
{
	...
	float data_row_02_swap[9] = { 7, 8, 9, 4, 5, 6, 1, 2, 3, };
...
bool MatrixTest::squareMatrixTests()
{
	...
	float data_check[9] = { 1.01158503f, 0.02190432f, 0.03238144f, 0.04349195f, 1.05428524f, 0.06539627f, 0.07576783f, 0.08708946f, 1.10894048f };
